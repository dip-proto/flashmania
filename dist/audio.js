...
export class AudioSystem {
    constructor() {
        ...
        this.surfaceOscillator = null;
        this.surfaceGain = null;
        this.muted = false;
        this.lastSurface = 'air';
    ...
    ensureEngine() {
        if (!this.audioContext || !this.masterGain || this.engineOscillator)
            return;
    ...
    ensureWind() {
        if (!this.audioContext || !this.masterGain || this.windOscillator)
            return;
    ...
    updateWind(car) {
        if (!this.audioContext || !this.windOscillator || !this.windGain || !this.windFilter)
            return;
        const speed = car.speed;
    ...
    ensureSurface() {
        if (!this.audioContext || !this.masterGain || this.surfaceOscillator)
            return;
    ...
    updateSurface(car) {
        if (!this.audioContext || !this.surfaceOscillator || !this.surfaceGain)
            return;
        if (car.isAirborne) {
