...
import { CarState, Vector2D, SurfaceType, InputState, PhysicsConfig, SpecialEffect } from './types';
...
export class Physics {
  ...
  update(car: CarState, input: InputState, dt: number): void {
    const hasEffect = (effect: SpecialEffect) => car.effects.has(effect);
